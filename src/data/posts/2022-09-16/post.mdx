...
<Callout>
  브라우저마다 사용하는 자바스크립트 엔진 종류 - **Chrome**: V8 - **Edge(Internet Explorer)**:
  Chakra - **Firefox**: Spider Monkey - **Safari**: Javascript Core Webkit
</Callout>
...
<Callout kind="question">
  **Promise**와 **Microtask Queue** 그림에는 표시되지 않았지만 기존 Callback Queue에 더해 Microtask
