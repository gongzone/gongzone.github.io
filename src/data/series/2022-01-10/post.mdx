...
description: '2222'
slug: 'simple-pendulum-theory2'
image: './assets/pendulum.png'
category: '자바스크립트'
tags: ['Canvas', 'JavaScript']
date: '2022-01-10'
lastmod: '2022-01-16'
series: '자바스크립트를 기깔나게 다뤄봅시다!'
---

import { GatsbyImage, getImage } from 'gatsby-plugin-image';

<div>
  이전 글에서는 생각의 토대를 정리하는 시간을 가졌습니다. 단진자를 움직이게 하는 진정한 힘이
  무엇인지, 그리고 우리가 구현을 위해서 무엇을 찾아야하는지 같은 것들 말이죠. 이번 글에서는
  자바스크립트 Canvas API를 이용해 구현하는 단계로 나아가보죠. <br />
  <br />
  <strong>이전 글 링크: </strong>
  <Link to="/simple-pendulum-theory">Canvas API로 만들어보는 단진자 운동(1)</Link>
</div>
...
<div display="info">
  단진자의 가정에서 볼 수 있듯이 공기 저항력 같은 마찰력을 고려하지 않았기 때문에 우리의 진자는
  영원히 같은 진폭을 유지하며 흔들릴 것입니다. 임의로 저항력을 주어 제동이 걸리게 하고 싶다면 아래와
  같은 코드를 추가하면 됩니다.
  <br />
  <br />
  ...
  <br />
  <br />
  이렇게 하면 속도가 점차 줄기 때문에 <strong>damping effect(감쇠 효과)</strong>을 얻을 수 있습니다.
</div>
